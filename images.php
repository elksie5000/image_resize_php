...
if(!isset($directoryname))  $directoryname = urldecode(stripslashes(__clean($_GET['directoryname'], 256)));
if(!isset($subdirectory))  $subdirectory = urldecode(stripslashes(__clean($_GET['subdirectory'], 256)));

if(!isset($size))  $size = __clean($_GET['size'], 9);

$uri = $directoryname."/". $subdirectory."/".$path;
